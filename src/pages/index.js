    ...
    <>
      ...
      <main>
        ...
        <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-[95vh]">
          <div className="absolute top-0 w-full h-full bg-top bg-cover bg-[url('https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2134&q=80')] ">
            <span
              id="blackOverlay"
          ...
          <div className="top-auto bottom-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden height: 70px; transform: translateZ(0px)">
            <svg
              ...
              >
                <div className="px-6">
                  <img
                    ...
                    className="shadow-lg rounded max-w-full mx-auto max-width: 250px"
                  />
        ...
        <section className="pb-20 relative block bg-black text-white">
          <div className="bottom-auto top-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden -mt-20 height: 80px; transform: translate-z-0">
            <svg
              className="absolute bottom-0 overflow-hidden"
              xmlns="http://www.w3.org/2000/svg"
              preserveAspectRatio="none"
                ...
                >
                  <div className="flex-auto p-5 lg:p-10 bg-orange-500 text-white">
                    ...
                    <div className="relative w-full mb-3 mt-8">
                      ...
                      <input
                        type="text"
                        className="px-3 py-3 placeholder-gray-400 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full transition: all 0.15s ease 0s"
                    ...
                    <div className="text-center mt-6">
                      <button
                        className="bg-gray-900 text-white active:bg-gray-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 transition: all 0.15s ease 0s"
                        type="button"
                      >
                        Send Message
                      </button>
